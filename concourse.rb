...
class Concourse < Formula
  ...
  if OS.mac?
    url 'https://github.com/concourse/concourse/releases/download/v4.2.2/concourse_darwin_amd64'
    sha256 'cfd26dbe70d8ba24a7ebbf0ef8b11fe06f7d16bc45b5e8fee39acb85885d1267'
  elsif OS.linux?
    url 'https://github.com/concourse/concourse/releases/download/v4.2.2/concourse_linux_amd64'
